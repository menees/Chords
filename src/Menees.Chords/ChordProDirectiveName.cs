...
public sealed class ChordProDirectiveName : IEquatable<ChordProDirectiveName>
{
	...
	private static readonly Dictionary<string, string> LongNameToShortNameMap = new(Comparer)
	{
		...
		{ "comment_box", "cb" },
		{ "comment_italic", "ci" },
		{ ChordProEnvironment.EndPrefix + ChordProEnvironment.BridgeName, "eob" },
		{ ChordProEnvironment.EndPrefix + ChordProEnvironment.ChorusName, "eoc" },
		{ ChordProEnvironment.EndPrefix + ChordProEnvironment.GridName, "eog" },
		{ ChordProEnvironment.EndPrefix + ChordProEnvironment.TabName, "eot" },
		{ ChordProEnvironment.EndPrefix + ChordProEnvironment.VerseName, "eov" },
		{ "grid", "g" },
		{ "new_page", "np" },
		{ "new_physical_page", "npp" },
		{ "new_song", "ns" },
		{ "no_grid", "ng" },
		{ ChordProEnvironment.StartPrefix + ChordProEnvironment.BridgeName, "sob" },
		{ ChordProEnvironment.StartPrefix + ChordProEnvironment.ChorusName, "soc" },
		{ ChordProEnvironment.StartPrefix + ChordProEnvironment.GridName, "sog" },
		{ ChordProEnvironment.StartPrefix + ChordProEnvironment.TabName, "sot" },
		{ ChordProEnvironment.StartPrefix + ChordProEnvironment.VerseName, "sov" },
		{ "subtitle", "st" },
		{ "textfont", "tf" },
		{ "textsize", "ts" },
		{ "title", "t" },
